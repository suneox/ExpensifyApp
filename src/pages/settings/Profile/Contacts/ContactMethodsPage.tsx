...
function ContactMethodsPage({route}: ContactMethodsPageProps) {
    ...
    const onNewContactMethodButtonPress = useCallback(() => {
        ...
        if (!isUserValidated) {
            Navigation.navigate(ROUTES.SETTINGS_CONTACT_METHOD_VERIFY_ACCOUNT.getRoute(Navigation.getActiveRoute(), ROUTES.SETTINGS_NEW_CONTACT_METHOD_CONFIRM_MAGIC_CODE.getRoute(navigateBackTo)));
            return;
        }
